...
let dir_load ppf name =
  action_on_suberror (My_topeval.load_file false ppf name)
...
let dir_load_rec ppf name =
  action_on_suberror (My_topeval.load_file true ppf name)
...
let load_file = My_topeval.load_file false

(* Load commands from a file *)

let dir_use ppf name =
  action_on_suberror (My_toploop.use_input ppf (My_toploop.File name))
let dir_use_output ppf name = action_on_suberror (My_toploop.use_output ppf name)
let dir_mod_use ppf name =
  action_on_suberror (My_toploop.mod_use_input ppf (My_toploop.File name))
